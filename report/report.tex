...
Where F\# lacks in comparison to Haskell is higher-kinded types. There is no polymorphism over type constructors, meaning you cannot, for example, write a generic map implementation of a \texttt{map} function for any type constructor. We can write the following in F\#:
\begin{lstlisting}
